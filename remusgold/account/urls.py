...
from remusgold.account.views import RegisterView, GetView, ShippingView, BillingView, ObtainAuthTokenWithId, register_activate, reset_password_request_token
from rest_framework.authtoken import views

from django_rest_resetpassword.views import reset_password_confirm, reset_password_validate_token
